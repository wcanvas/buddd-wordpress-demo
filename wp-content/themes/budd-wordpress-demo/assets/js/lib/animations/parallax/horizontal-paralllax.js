...
export default class ParallaxEffectHorizontal {
	/**
	 * ParallaxEffectHorizontal constructor
	 * @param {HTMLElement|NodeList} elements array of elements to animate.
	 * @param {string} direction direction of the parallax effect, either 'left', 'right', or 'auto'.
	 */
